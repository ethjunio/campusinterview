  ...
  "
    ...
    >
      ...
      <div className="relative  w-full max-w-6xl overflow-hidden  mx-auto">
        {/* LEFT BUTTON */}
        <button className="testimonial-prev absolute left-2 sm:left-4 top-1/2 -translate-y-1/2 z-20 bg-black text-white p-2 sm:p-3 rounded-full">
          <ArrowLeft size={18} />
        </button>

        {/* RIGHT BUTTON */}
        <button className="testimonial-next absolute right-2 sm:right-4 top-1/2 -translate-y-1/2 z-20 bg-black text-white p-2 sm:p-3 rounded-full">
          <ArrowRight size={18} />
        </button>
        ...
        "
            >
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <h4 className="font-thin text-[#0621B7] !text-[22px] leading-[26px] mb-2">
                    {item.name}
                  </h4>
