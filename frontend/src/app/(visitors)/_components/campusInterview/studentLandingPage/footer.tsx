          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
            ...
            <div className="space-y-8">
              ...
              <div className="text-gray-800 text-base leading-relaxed">
                <p className="text-[#020418] text-[12.3px]">ETH Juniors</p>
                <p className="text-[#020418] text-[12.3px]">Hochstrasse 60a</p>
                <p className="text-[#020418] text-[12.3px]">
              ...
              <div className="space-y-3 text-lg">
                <div className="flex items-center gap-3">
                  ...
                  <a
                    ...
                    className="text-[#020418] text-[16px]"
                  >
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-12">
              ...
              <div className="order-1">
                <h4 className="text-[#020418] text-sm mb-3 font-thin text-[12px]">
                  Account
                </h4>
                <ul className="space-y-1 text-xl font-medium">
                  <li>
                    <a
                      href="/login"
                      className="hover:opacity-70 text-[#020418] text-sm mb-3 !text-[16px]"
                    >
                      Login
                    </a>
                  </li>
              ...
              <div className="order-2 md:order-3">
                <h4 className="text-[#020418] text-sm mb-3 font-thin text-[16px]">
                  Policy
                </h4>
                <ul className="space-y-1 text-xl font-medium">
                  <li>
