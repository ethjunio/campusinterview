          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 ">
            ...
            <div className="lg:col-span-2 pt-5 bg-white rounded-md shadow-sm">
              <div className="flex flex-col items-center justify-center gap-[2px] w-full max-w-[1259px] mx-auto my-6">
                ...
                <p className="text-xl font-semibold font-sans text-[#0621B7] !text-[22px] leading-[26px]">
            ...
            <div className="space-y-4 gap-6 ">
              ...
              <div className="p-8 bg-accent  rounded-md shadow p-4 bg-white flex flex-col items-start gap-6 px-[24px] py-[20px] bg-white ">
                ...
                <div className="flex items-start gap-4">
                  {/* Icon */}
                  <MapPin className="ml-2 w-8 h-8 text-[#0621B7] mt-2  object-contain
                  
                  " />

                
                <div className="flex flex-col">
                    <p className="font-normal text-[#6A7282] text-[16px] leading-[20px] font-thin">
                      Location
                    </p>

                    <p className="text-[#101828] text-[18px] leading-[20px] font-thin">
                      Mövenpick Hotel Zürich Airport <br />
                      Walter Mittelholzerstrasse 8 <br />
                      8152 Opfikon
                    </p>
                  </div>
                </div>
