      ...
      <div className="mx-auto">
        <div className="lg:grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6">
          <div className="order-2 mb-3 md:order-1 lg:order-1 relative rounded-2xl overflow-hidden aspect-[3/4] lg:aspect-auto lg:min-h-[600px]">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-[#1454CE]/60 via-[#1454CE]/20 to-transparent" />
            <div className="absolute bottom-0 left-0 right-0 p-5 sm:p-6 text-primary-foreground">
              ...
              <Link
                ...
                className="flex items-center gap-2 w-full justify-center backdrop-blur-sm text-white rounded-xl px-5 py-2.5 text-base font-medium hover:bg-primary/30 transition-colors bg-[linear-gradient(90deg,#1454CE_63%,#0621B7_100%)] text-[16px] leading-[20px]"
              >
          ...
          <div className="order-1 md:col-span-2 lg:col-span-1 lg:order-2 flex flex-col items-center text-center gap-4 hero-mid h-full ">
            <div className=" bg-white rounded-2xl p-6 sm:p-8 w-full flex flex-col items-center logo-block">
              <div className="w-20 h-20 sm:w-[125px] sm:h-[125px]  rounded-full flex items-center justify-center mb-1">
                <img
                  src={"/img/logo_solo.svg"}
                  alt={`${brandName} Logo`}
                  className="w-14 h-14 mb-5 sm:w-[125px] sm:h-[125px] object-contain"
                />
              </div>
              <h1 className="font-bold text-[#1968FF] text-[26px] leading-[30px] mb-2">
                {brandName}
              </h1>
              <p className="text-[#1968FF] text-[17px] leading-[22px]">
                organized by ETH juniors
              </p>
            </div>

            <div className=" text-white rounded-2xl !px-[30px] !py-[25px] sm:py-5 w-full bg-[linear-gradient(90deg,#1454CE_25%,#0621B7_100%)]">
            ...
            <div className="mt-auto pb-4 space-y-4 mb-3">
              <div>
                ...
                <p className="flex items-center justify-center gap-2 font-semibold  !text-[#1968FF] text-[22px] leading-[26px]">
          ...
          <div className="order-3 relative rounded-2xl overflow-hidden aspect-[3/4] lg:aspect-auto lg:min-h-[600px]">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-5 sm:p-6 text-primary-foreground">
              ...
              <Link
                ...
                className="flex items-center gap-2 w-full justify-center backdrop-blur-sm  text-primary-foreground rounded-xl px-5 py-2.5 font-medium hover:bg-primary/30 transition-colors text-white bg-[linear-gradient(90deg,#1454CE_63%,#0621B7_100%)] text-[16px] leading-[20px]"
              >
                Find out more <ArrowRight className="w-4 h-4" />
              </Link>
            </div>
