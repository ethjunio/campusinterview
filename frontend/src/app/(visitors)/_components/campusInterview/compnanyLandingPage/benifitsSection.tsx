          ...
          >
            <div className="space-y-5">
              ...
              <p className="text-base font-light text-muted-foreground leading-relaxed text-[#020418] text-[16px] leading-[22px]">
                ...
                to prone entrepreneurship. The Campus Interview is the
              ...
              <div className="block lg:flex flex-col sm:flex-row gap-3">
                ...
                >
                  <button
                    className="bg-[linear-gradient(90deg,#1454CE_63%,#0621B7_100%)] text-white mb-3 py-3 px-4 
                ...
                <a href="tel:+41446326638">
                  <button
                    className="bg-[linear-gradient(90deg,#1454CE_63%,#0621B7_100%)] text-white py-3 px-4 
                         rounded-full text-sm font-medium 
                         hover:opacity-90 transition-opacity 
                         flex items-center justify-center gap-2  text-[14px]"
                  >
