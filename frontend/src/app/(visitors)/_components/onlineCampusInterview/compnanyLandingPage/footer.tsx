...
const Footer = () => {
  return (
    <footer className="bg-[#f5f5f5] py-20">
      <div className="max-w-7xl mx-auto px-6 bg-white p-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
          ...
          <div className="grid grid-cols-3 gap-12">
            ...
            {/* Account */}
            <div>
              <h4 className="text-gray-500 text-sm mb-6">Account</h4>
              <ul className="space-y-4 text-xl font-medium">
                <li>
                  <a href="#" className="hover:opacity-70 transition text-gray-900">
                    Login
                  </a>
                </li>
                <li>
            ...
            {/* Position */}
            <div>
              <h4 className="text-gray-500 text-sm mb-6">Position</h4>
              <ul className="space-y-4 text-xl font-medium">
            ...
            {/* Policy */}
            <div>
              <h4 className="text-gray-500 text-sm mb-6 ">Policy</h4>
              <ul className="space-y-4 text-xl font-medium">
