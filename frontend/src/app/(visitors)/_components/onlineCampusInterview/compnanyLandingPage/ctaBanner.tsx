      ...
      >
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center text-center py-12 sm:py-0 sm:pb-5 sm:pt-5 lg:py-20 px-4 sm:px-6">
            ...
            <Link
              href="/register"
              className="px-6 py-2.5 bg-primaryPurple text-gray-100 text-sm sm:text-base font-medium rounded-full hover:opacity-90 transition-opacity text-[22px] text-[#fff]"
            >
              Join now !
            </Link>
          </div>
