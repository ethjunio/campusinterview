...
const ExtracurricularsFeature = ({ routePath }: params) => {
  ...
  const createExtracurricularFormMutation =
    useExtraCurricularFormCreateMutation({
  ...
  return (
    <div>
      ...
      <ProfileForm>
                  ...
                  <Form>
                    <div className="mb-10">
                      <div className="flex justify-between items-center max-w-full xl:max-w-md">
                        <div>
                          <h1 className="">
                            {t("candidate.extracurriculars.title")}
                          </h1>
                        </div>
                        <div>
        ...
        {/* {data?.data?.length === 0 ? (
          <li className="lead-text">{"No extracurriculares added yet, it's lonely in here"}</li>
        ) : null} */}
      </ProfileForm>
      {showDialog && (
