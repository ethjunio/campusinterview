...
const Message: React.FC<MessageProps> = ({ children, date, from, photo,attachment ,pending}) => {
  const isMessageFromMe = from === 'candidate';
  ...
  return (
    <div className={containerClass}>
      {!isMessageFromMe ? (
        // <img src={photo} className="flex-shrink-0 rounded-full w-6 h-6 mr-3" />
      ...
      <div className="bg-white pt-5 pb-5k pl-7 pr-7 rounded-lg max-w-xs sm:max-w-xl whitespace-pre-line">
        {children}
        {attachment?.length > 0 && (
