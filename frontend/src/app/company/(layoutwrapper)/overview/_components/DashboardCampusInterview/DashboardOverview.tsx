...
const DashboardCampusInterview = () => {
  return (
        ...
        <div className="p-4 md:p-6 lg:p-8 max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-[minmax(280px,380px)_1fr] lg:grid-cols-[minmax(300px,440px)_1fr] gap-6 lg:gap-8">
            ...
            <div className="space-y-4">
              <div>
                <h1 className="text-3xl lg:text-4xl font-light text-foreground leading-tightest">
                  Welcome to
                  <br />
                  Campus Interview
                </h1>
                <Link href="/company/profile/bookings">
                  <button className="mt-4 flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-[#2A7AFF] to-[#1454CE] px-6 py-3 text-sm font-semibold text-white hover:opacity-90 transition-opacity">
...
export default DashboardCampusInterview;
