  ...
  return (
    <div className="rounded-xl bg-white p-5">
      <div className="flex items-center gap-2 mb-4">
        <Contact size={18} className="text-primaryPurple" />
        <h3 className="text-xl font-bold text-foreground !text-[18px] leading-[28px] text-[#101828] font-thin">
          Contact
        </h3>
      </div>
      ...
      <div className="space-y-3">
        <a
          ...
          className="flex items-center gap-3 hover:underline !text-[14px] leading-[20px] !text-[#8072FF] font-normal"
        >
          <div className="flex flex-row justify-center items-center w-[40px] h-[40px] bg-gray-100 rounded-[14px] flex-none ">
            <Mail size={16} className="shrink-0 text-primaryPurple" />
          </div>
