...
export const WorkshopRoom: FC<Props> = ({
  ...
  const basePrice =room?.onlineCampusPrice
    ...
    <BookingCard disabled={disabled}>
      ...
      <BookingCard.Body>
        <BookingCard.Body.Lead>
          {t('bookings.add-workshopOnline-room-description')}
        </BookingCard.Body.Lead>
        <BookingCard.Body.List
          items={[
            t('bookings.add-workshopOnline-room-list-1'),
            t('bookings.add-workshopOnline-room-list-2'),
