    ...
    <BookingCard disabled={disabled}>
      ...
      <BookingCard.Body>
        <BookingCard.Body.Lead>
          {t("bookings.add-premium-room-description")}
        </BookingCard.Body.Lead>
        <BookingCard.Body.List
          items={[
            t("bookings.add-premium-room-list-1"),
            t("bookings.add-premium-room-list-2"),
            t("bookings.add-premium-room-list-3"),
            t("bookings.add-premium-room-list-4"),
            t("bookings.add-premium-room-list-5"),
            t("bookings.add-premium-room-list-6"),
            t("bookings.add-premium-room-list-7"),
            t("bookings.add-premium-room-list-8"),
          ]}
        />
