...
import { ProcessInfo } from "../../../rooms/_components/OnlineCamousInterview/ProcessInfo";
import { Services } from "./Services";

const OnlineAdditionalServices: NextPage<BookingPageProps> = ({ bookings }) => {
...
export default OnlineAdditionalServices;
