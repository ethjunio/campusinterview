  ...
  return (
    <BookingCard disabled={disabled}>
      <BookingCard.Header Icon={IconMiniBooth}>
        {t('companies.bookings.mini-booth')}
        {/* {t('companies.bookings.left-count', { count: service?.remaining })} */}
      </BookingCard.Header>
      <BookingCard.Body>
        <BookingCard.Body.Lead>
          {t('companies.bookings.add-services-miniBooth-description')}
        </BookingCard.Body.Lead>
        <BookingCard.Body.List
          items={[
            t('companies.bookings.add-services-miniBooth-list-1'),
            t('companies.bookings.add-services-miniBooth-list-2'),
            t('companies.bookings.add-services-miniBooth-list-3'),
            t('companies.bookings.add-services-miniBooth-list-4'),
          ]}
        />
      </BookingCard.Body>
