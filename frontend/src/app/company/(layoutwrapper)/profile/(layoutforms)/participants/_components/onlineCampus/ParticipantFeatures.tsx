...
const OnlineParticipantFeatures = ({ button }: { button?: any }) => {
  ...
  const [formData, setFormData] = useState([
    {
      ...
      attending: false,
      attendanceSlot: "",
      areDailyNotificationsEnabled: false,
      userId: "",
    },
  ]);
  ...
  useEffect(() => {
    if (data?.participants) {
      ...
      const initialFormValues = data.participants.map((item: any) => ({
        ...
        areDailyNotificationsEnabled:
          item?.areDailyNotificationsEnabled || false,
      }));
    ...
    <div>
      <ProfileForm>
        <div className="flex justify-between items-center max-w-full xl:max-w-md mb-10">
          <div>
            <h1 className="">{t("companies.participants.title")}</h1>
          </div>
          <div>
                ...
                <div className="flex-grow max-w-screen-full lg:max-w-screen-md vstack vstack-1">
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <input
                      ...
                      placeholder={t(
                        "companies.participants.form-password-placeholder"
                      )}
                    />
                  </div>
                    ...
                    <div className="flex flex-col gap-4 mt-6">
                      ...
                      >
                        <option value="" disabled>
                          {t(
                            "companies.participants.form-attendanceSlot-placeholder"
                          )}
                        </option>
    ...
    /> */}
                      ...
                      <TooltipProvider delayDuration={150}>
                        <Tooltip>
                          ...
                          <TooltipContent className="z-[9999] max-w-xs rounded border border-gray-200 bg-white p-2 text-sm text-gray-900 shadow-lg">
                            Sends daily notifications to this participant when
                            enabled.
                          </TooltipContent>
                        </Tooltip>
                      </TooltipProvider>
...
export default OnlineParticipantFeatures;
